...
STRINGS = {
    "en": {
        ...
        "admin_help": "🛠 **Admin Control Panel**\n\n**General Commands:**\n/stats - View bot statistics\n/setprice 199 - Update price to ₹199\n/setupi name@upi - Update UPI ID\n/setwelcome en <text> - Set English welcome text\n/setsuccess hi <text> - Set Hindi success text\n/addadmin <user_id> - Add a new admin\n\n**Image Database Commands:**\n/setdatabase <channel_id> - Designate an image storage channel\n\n**How to update images:**\n1. Use `/setdatabase` to link your channel (one-time setup).\n2. Simply **send a photo** to this bot chat.\n3. A menu will appear asking where you want to show it.\n4. The bot will automatically copy it to your channel and set it up!",
    ...
    "hi": {
        ...
        "admin_help": "🛠 **एडमिन कंट्रोल पैनल**\n\n**सामान्य कमांड:**\n/stats - बॉट आँकड़े देखें\n/setprice 199 - मूल्य को ₹199 तक अपडेट करें\n/setupi name@upi - UPI ID अपडेट करें\n/setwelcome en <text> - अंग्रेजी स्वागत टेक्स्ट सेट करें\n/setsuccess hi <text> - हिंदी सफलता टेक्स्ट सेट करें\n/addadmin <user_id> - नया एडमिन जोड़ें\n\n**इमेज डेटाबेस कमांड:**\n/setdatabase <channel_id> - एक इमेज स्टोरेज चैनल नामित करें\n\n**इमेज कैसे अपडेट करें:**\n1. अपने चैनल को लिंक करने के लिए `/setdatabase` का उपयोग करें (एक बार का सेटअप)।\n2. बस इस बॉट चैट में **एक फोटो भेजें**।\n3. एक मेनू दिखाई देगा जिसमें पूछा जाएगा कि आप इसे कहाँ दिखाना चाहते हैं।\n4. बॉट इसे स्वचालित रूप से आपके चैनल पर कॉपी कर देगा और सेटअप कर देगा!",
