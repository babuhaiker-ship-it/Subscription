...
STRINGS = {
    "en": {
        ...
        "btn_pay_xmr": "🔒 Pay with Monero (${price_usd:.2f})",
        "btn_check_btc": "🔄 Check Payment Status",
        "btn_check_xmr": "🔄 Check Payment Status",
        "btn_back": "🔙 Main Menu",
        ...
        "xmr_instr": "🔒 **Monero (XMR) Payment Invoice**\n\n📦 **Plan:** {plan_name} ({days} Days)\n💰 **Amount:** `{xmr_amount:.6f} XMR` (${price_usd:.2f})\n\n📍 **Monero Deposit Address:**\n`{address}`\n\n⏰ **Invoice Expiry:** `{expiry_str}` UTC\n\n📲 *Scan QR code below or copy the address above. Send exact XMR amount and click 'Check Payment Status' after sending.*",
    ...
    "hi": {
        ...
        "btn_pay_xmr": "🔒 मोनेरो (XMR) से भुगतान करें (${price_usd:.2f})",
        "btn_check_btc": "🔄 भुगतान स्थिति जांचें",
        "btn_check_xmr": "🔄 भुगतान स्थिति जांचें",
        "btn_back": "🔙 मुख्य मेनू",
        "btc_instr": "₿ **बिटकोइन भुगतान बीजक**\n\n📦 **प्लान:** {plan_name} ({days} दिन)\n💰 **राशि:** `{btc_amount:.8f} BTC` (${price_usd:.2f})\n\n📍 **बिटकोइन जमा पता:**\n`{address}`\n\n⏰ **समाप्ति समय:** `{expiry_str}` UTC",
        "xmr_instr": "🔒 **मोनेरो (XMR) भुगतान बीजक**\n\n📦 **प्लान:** {plan_name} ({days} दिन)\n💰 **राशि:** `{xmr_amount:.6f} XMR` (${price_usd:.2f})\n\n📍 **मोनेरो जमा पता:**\n`{address}`\n\n⏰ **समाप्ति समय:** `{expiry_str}` UTC",
